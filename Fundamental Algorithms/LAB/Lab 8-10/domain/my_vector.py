class MyVector:
    ...
    def __str__(self):
        ...
        Error: -
        """
        return "Vector " + str(self.get_name_id()) + \
    ...
    def add_vector(self, other):
        ...
        Adds two vectors
        In: other - vector
        Out: my_values - list of integers and/or floats, sum of the values of the two vectors
    ...
    def sub_vector(self, other):
        ...
        In: other - vector
        Out: my_values - list of integers and/or floats, difference of the values of the two vectors
        Error: ValueError if other is not a vector or if the vectors have different lengths
        """
        if not isinstance(other, MyVector):
            raise ValueError("Invalid type!\n")
    ...
    def mul_vector(self, other):
        ...
        mul = 0
        for i in range(len(my_values)):
            mul += my_values[i] * other_values[i]
        return mul
...
# p1 = MyVector(1, 'r', 1, [1, 2.0, -3])
# print(p1.maximum_of_elements())
# print(p1.minimum_of_elements())
#
# p2 = MyVector(2, 'g', 1, [1, 2.0, 4])
# print(p2.average_of_elements())
#
# p3 = MyVector(3, 'b', 2, [1, 2, 3, 4])
# print(p3.sum_of_elements())
#
# p4 = MyVector(4, 'y', 3, [2, 3, 4])
# print(p4.prod_of_elements())
#
# p5 = MyVector(5, 'm', 4, [1, 2, 3, 4])
# print(p5.average_of_elements())
